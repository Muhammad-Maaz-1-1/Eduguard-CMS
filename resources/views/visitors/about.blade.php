      @extends('visitors.layouts.main')
        @section('main-container')   <!-- Breadcrumb Starts Here -->
        <div class="py-0">
            <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 position-relative mt-4 mt-lg-0" style="z-index: 0;">
                        <div class="about-intro__img-wrapper">
                            <img src="dist/images/about/intro.jpg" alt="Intro Image" class="img-fluid rounded-2 ms-lg-5 position-relative intro-image" />
                        </div>
                        <div class="intro-shape">
                            <img src="dist/images/shape/rec04.png" alt="Shape" class="img-fluid shape-01" />
                            <img src="dist/images/shape/dots/dots-img-09.png" alt="Shape" class="img-fluid shape-02" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-intro__textContent">
                            ...
                            <p class="mt-2 mt-lg-1 mb-2 mb-lg-4 text-secondary">
                                Vestibulum efficitur accumsan sapien ut lacinia. Sed euismod ullamcorper rhoncus. Phasellus interdum rutrum nisi ut lacinia. Nulla et sapien at turpis viverra. Cras odio ex, posuere id est et, viverra
                                condimentum felis
                            </p>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about-feature dark-feature">
                            ...
                            <p class="text-lowblack">
                                Suspendisse potenti. Pellentesque augue ligula, dictum at pretium eu, fermentum sit amet risus. Maecenas congue feugiat libero, sed euismod urna congue eleifend. Maecenas et gravida felis. Vivamus iaculis
                    ...
                    <div class="col-lg-6 mt-4 mt-lg-0">
                        <div class="about-feature">
                            ...
                            <p class="text-secondary">
                                Maecenas consectetur ultrices tortor, eget efficitur tortor finibus at. Sed convallis efficitur turpis, eget dapibus magna. Nam euismod lacus ac nulla vehicula aliquam.Curabitur efficitur vehicula sagittis.
        ...
        <section class="section best-instructor-featured overflow-hidden main-instructor-featured">
            ...
            <div class="main-instructor-featured-shape">
                <img src="dist/images/shape/dots/dots-img-14.png" alt="shape" class="img-fluid shape01" />
                <img src="dist/images/shape/triangel2.png" alt="shape" class="img-fluid shape02" />
            </div>
        </section>
