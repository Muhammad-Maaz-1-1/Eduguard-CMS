  @extends('visitors.layouts.main')
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 order-1 order-lg-0">
                        <div class="main-banner-end">
                            <img src="{{ asset('assets') }}/dist/images/banner/banner-image-01.png" alt="image" class="img-fluid" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="section browse-categories">
            ...
            <div class="browse-categories-shape">
                <img src="{{ asset('assets') }}/dist/images/shape/dots/dots-img-11.png" alt="shape" class="img-fluid shape-01" />
                <img src="{{ asset('assets') }}/dist/images/shape/line01.png" alt="shape" class="img-fluid shape-02" />
            </div>
        </section>
        ...
        <section class="section section--bg-offwhite-three featured-popular-courses main-popular-course">
                        ...
                        <div class="tab-pane fade show active" id="pills-all" role="tabpanel" aria-labelledby="pills-all-tab">
                            <div class="row">
                                <div class="col-xl-4 col-md-6">
                                    <div class="contentCard contentCard--course">
                                        <div class="contentCard-top">
                                            <a href="{{ route('course_detail') }}"><img src="{{ asset('assets') }}/dist/images/courses/demo-img-01.png" alt="images" class="img-fluid" /></a>
                                        </div>
                                        <div class="contentCard-bottom">
                                            <h5>
                                                <a href="{{ route('course_detail') }}" class="font-title--card">Chicago International Conference on Education</a>
                                            </h5>
                                            <div class="contentCard-info d-flex align-items-center justify-content-between">
                                                <a href="instructor-profile.html" class="contentCard-user d-flex align-items-center">
                                                    <img src="{{ asset('assets') }}/dist/images/courses/7.png" alt="client-image" class="rounded-circle" />
                                            ...
                                            <div class="contentCard-more">
                                                <div class="d-flex align-items-center">
                                                    <div class="icon">
                                                        <img src="{{ asset('assets') }}/dist/images/icon/star.png" alt="star" />
                                                    </div>
                                                    <span>4.5</span>
                                                </div>
                                                <div class="eye d-flex align-items-center">
                                                    <div class="icon">
                                                        <img src="{{ asset('assets') }}/dist/images/icon/eye.png" alt="eye" />
                                                    </div>
                                                    <span>24,517</span>
                                                </div>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="contentCard contentCard--course">
                                        <div class="contentCard-top">
                                            <a href="{{ route('course_detail') }}"><img src="{{ asset('assets') }}/dist/images/courses/demo-img-02.png" alt="images" class="img-fluid" /></a>
                                        </div>
                                        <div class="contentCard-bottom">
                                            <h5>
                                                <a href="{{ route('course_detail') }}" class="font-title--card">Chicago International Conference on Education</a>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="contentCard contentCard--course">
                                        <div class="contentCard-top">
                                            <a href="{{ route('course_detail') }}"><img src="{{ asset('assets') }}/dist/images/courses/demo-img-03.png" alt="images" class="img-fluid" /></a>
                                        </div>
                                        <div class="contentCard-bottom">
                                            <h5>
                                                <a href="{{ route('course_detail') }}" class="font-title--card">Chicago International Conference on Education</a>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="contentCard contentCard--course">
                                        <div class="contentCard-top">
                                            <a href="{{ route('course_detail') }}"><img src="{{ asset('assets') }}/dist/images/courses/demo-img-04.png" alt="images" class="img-fluid" /></a>
                                        </div>
                                        <div class="contentCard-bottom">
                                            <h5>
                                                <a href="{{ route('course_detail') }}" class="font-title--card">Chicago International Conference on Education</a>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="contentCard contentCard--course">
                                        <div class="contentCard-top">
                                            <a href="{{ route('course_detail') }}"><img src="{{ asset('assets') }}/dist/images/courses/demo-img-05.png" alt="images" class="img-fluid" /></a>
                                        </div>
                                        <div class="contentCard-bottom">
                                            <h5>
                                                <a href="{{ route('course_detail') }}" class="font-title--card">Chicago International Conference on Education</a>
                                    ...
                                    <div class="contentCard contentCard--course">
                                        <div class="contentCard-top">
                                            <a href="{{ route('course_detail') }}">
                                                <img src="{{ asset('assets') }}/dist/images/courses/demo-img-02.png" alt="images" class="img-fluid" />
                                            </a>
                                        </div>
                                        <div class="contentCard-bottom">
                                            <h5>
            ...
            <div class="featured-popular-courses-shape">
                <img src="{{ asset('assets') }}/dist/images/shape/dots/dots-img-12.png" alt="Shape" class="img-fluid dot-06" />
                <img src="{{ asset('assets') }}/dist/images/shape/triangel.png" alt="Shape" class="img-fluid dot-07" />
            </div>
        </section>
                        ...
                        <div class="cardFeature">
                            <div class="cardFeature__icon cardFeature__icon--bg-b">
                                <svg width="28" height="27" viewBox="0 0 28 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M19.3855 12.224C21.8743 12.224 23.8915 10.2067 23.8915 7.71794C23.8915 5.23054 21.8743 3.21191 19.3855 3.21191" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <section class="section learning-rules">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 order-1 order-lg-0">
                        <div class="learning-rules-ends">
                            <img src="{{ asset('assets') }}/dist/images/hero/hero-img-01.jpg" alt="img" class="img-fluid" />
                            <div class="learning-rules-ends-circle">
                                <img src="{{ asset('assets') }}/dist/images/shape/l03.png" alt="shape" class="img-fluid" />
                            </div>
                            <div class="earning-rules-ends-shape">
                                <img src="{{ asset('assets') }}/dist/images/shape/l04.png" alt="shape" class="img-fluid shape-1" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="learning-rules-shape">
                <img src="{{ asset('assets') }}/dist/images/shape/dots/dots-img-16.png" alt="shape" class="img-fluid shape-01" />
                <img src="{{ asset('assets') }}/dist/images/shape/l02.png" alt="shape" class="img-fluid shape-02" />
            </div>
        </section>
        ...
        <section class="section about-services section section--bg-offgradient">
                        ...
                        <div class="testimonial__user-wrapper d-flex justify-content-between">
                            <div class="testimonial__user d-flex align-items-center">
                                <div class="testimonial__user-img">
                                    <img src="{{ asset('assets') }}/dist/images/avatar/avatar-img-01.png" alt="Client" />
                                </div>
            ...
            <div class="about-services-shape">
                <img src="{{ asset('assets') }}/dist/images/shape/line02.png" alt="shape" class="img-fluid img-shape-01" />
                <img src="{{ asset('assets') }}/dist/images/shape/dots/dots-img-13.png" alt="shape" class="img-fluid img-shape-02" />
                <img src="{{ asset('assets') }}/dist/images/shape/l02.png" alt="shape" class="img-fluid img-shape-03" />
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="brand-area">
                            <div class="brand-area-image">
                                <img src="{{ asset('assets') }}/dist/images/versity/1.png" alt="Brand" class="img-fluid" />
                            </div>
                            <div class="brand-area-image">
                                <img src="{{ asset('assets') }}/dist/images/versity/2.png" alt="Brand" class="img-fluid" />
                            </div>
                            <div class="brand-area-image">
                                <img src="{{ asset('assets') }}/dist/images/versity/3.png" alt="Brand" class="img-fluid" />
                            </div>
                            <div class="brand-area-image">
                                <img src="{{ asset('assets') }}/dist/images/versity/4.png" alt="Brand" class="img-fluid" />
                            </div>
                            <div class="brand-area-image">
                                <img src="{{ asset('assets') }}/dist/images/versity/2.png" alt="Brand" class="img-fluid" />
                            </div>
                            <div class="brand-area-image">
                                <img src="{{ asset('assets') }}/dist/images/versity/5.png" alt="Brand" class="img-fluid" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="section best-instructor-featured overflow-hidden main-instructor-featured">
                            ...
                            <div class="ourinstructor-active">
                                <div class="mentor">
                                    <div class="mentor__img">
                                        <img src="{{ asset('assets') }}/dist/images/instructor/03.jpg" alt="Mentor image" />
                                ...
                                <div class="mentor">
                                    <div class="mentor__img">
                                        <img src="{{ asset('assets') }}/dist/images/instructor/02.jpg" alt="Mentor image" />
                                        <ul class="list-inline">
                                            <li class="list-inline-item">
                                                <a href="#" tabindex="0">
                                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="mentor">
                                    <div class="mentor__img">
                                        <img src="{{ asset('assets') }}/dist/images/instructor/3.jpg" alt="Mentor image" />
                                        <ul class="list-inline">
                                            <li class="list-inline-item">
                                                <a href="#" tabindex="0">
                                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="mentor">
                                    <div class="mentor__img">
                                        <img src="{{ asset('assets') }}/dist/images/instructor/04.jpg" alt="Mentor image" />
                                        <ul class="list-inline">
                                            <li class="list-inline-item">
                                                <a href="#" tabindex="0">
                                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="mentor">
                                    <div class="mentor__img">
                                        <img src="{{ asset('assets') }}/dist/images/instructor/1.png" alt="Mentor image" />
                                        <ul class="list-inline">
                                            <li class="list-inline-item">
                                                <a href="#" tabindex="0">
                                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="mentor">
                                    <div class="mentor__img">
                                        <img src="{{ asset('assets') }}/dist/images/instructor/2.png" alt="Mentor image" />
                                        <ul class="list-inline">
                                            <li class="list-inline-item">
                                                <a href="#" tabindex="0">
                                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="main-instructor-featured-shape">
                <img src="{{ asset('assets') }}/dist/images/shape/dots/dots-img-14.png" alt="shape" class="img-fluid shape01" />
                <img src="{{ asset('assets') }}/dist/images/shape/triangel2.png" alt="shape" class="img-fluid shape02" />
            </div>
        </section>
        ...
        <section class="section section--bg-offwhite-three latest-events-featured main-events-featured">
            <div class="container">
                            ...
                            <div class="contentCard contentCard--event contentCard--space">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-more">
                                        <div class="d-flex align-items-center">
                                            <div class="icon">
                                                <img src="{{ asset('assets') }}/dist/images/icon/Location.png" alt="location" />
                                            </div>
                                            <span>Chicago, Illinois</span>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <div class="icon">
                                                <img src="{{ asset('assets') }}/dist/images/icon/calendar.png" alt="calendar" />
                                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <a href="event-search.html" class="button button-lg button--primary mt-lg-5 mt-5">Browse all events</a>
                    </div>
                </div>
            </div>
            <div class="main-events-featured-shape">
                <img src="{{ asset('assets') }}/dist/images/shape/triangel3.png" alt="shape" class="img-fluid shape01" />
            </div>
        </section>
        ...
        <section class="section main-become-instructor">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="main-become-instructor-item me-12">
                            <div class="main-image">
                                <img src="{{ asset('assets') }}/dist/images/event/image01.png" alt="image" class="img-fluid" />
                            </div>
                            <div class="main-text">
                    ...
                    <div class="col-lg-6">
                        <div class="main-become-instructor-item ms-12 mb-0">
                            <div class="main-image">
                                <img src="{{ asset('assets') }}/dist/images/event/image02.png" alt="image" class="img-fluid" />
                            </div>
                            <div class="main-text">
            ...
            <div class="main-become-instructor-shape">
                <img src="{{ asset('assets') }}/dist/images/shape/line03.png" alt="shape" class="img-fluid" />
            </div>
        </section>
