...
<form action="{{ route('search_submit') }}" method="GET">
    @csrf
    <div class="banner-input">
        <div class="main-input">
            <input type="text" name="search" placeholder="What do you want to learn today..." />
                    ...
                    <div class="categories--box">
                        ...
                        <div class="browse-categories-item default-item-one">
                            ...
                            <div class="browse-categories-item-text">
                                ...
                                <p>{{ $category->courses_count }}  Courses</p>
                            </div>
                        </div>
                        @endforeach
                                ...
                                <div class="col-xl-4 col-md-6">
                                   <div class="contentCard contentCard--course">
                                       <div class="contentCard-top">
                                           <a href="{{ route('course_detail') }}"><img src="{{ asset('uploads/'.$item->image) }}" alt="images" class="img-fluid" /></a>
                                       </div>
                                       <div class="contentCard-bottom">
                                           <h5>
                                               <a href="{{ route('course_detail') }}" class="font-title--card">{{$item->title}}</a>
                                           </h5>
                                           <div class="contentCard-info d-flex align-items-center justify-content-between">
                                               <a href="instructor-profile.html" class="contentCard-user d-flex align-items-center">
                                                   ...
                                                   <p class="font-para--md">{{$item->user->name}}</p>
                                               </a>
                                               <div class="price">
                                           ...
                                           <div class="contentCard-more">
                                               ...
                                               <div class="book d-flex align-items-center">
                                                   ...
                                                   <span>{{$item->total_lesson}} Lesson</span>
                                               </div>
                                               <div class="clock d-flex align-items-center">
                                                   <div class="icon">
                                                       <img src="{{ asset('assets') }}/dist/images/icon/Clock.png" alt="clock" />
                                                   </div>
                                                   <span>{{$item->total_hours}} Hours</span>
                                               </div>
                                           </div>
                                       </div>
                                   </div>
                               ...
                               @foreach ($instructors as $item)
                                ...
                                <div class="mentor">
                                    <div class="mentor__img">
                                        <img src="{{ asset('uploads/'.$item->profile->image) }}" alt="Mentor image" />
                                    ...
                                    <div class="mentor__title">
                                        <h6>
                                            <a href="instructor-profile.html" tabindex="0">{{$item->name}}</a>
                                        </h6>
                                        <p>{{$item->profile->skill}}</p>
                                    </div>
                                </div>
                               @endforeach
