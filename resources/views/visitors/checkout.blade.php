                        ...
                        <div class="checkout-tab">
                            <ul class="nav nav-pills mb-4" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <div class="nav-link active" id="pills-checkout-tab" data-bs-toggle="pill" data-bs-target="#pills-checkout" role="tab" aria-controls="pills-checkout" aria-selected="true">
                                        <svg width="45" height="34" viewBox="0 0 45 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            ></path>
                                            <path d="M2 13.25H43.25" stroke="#25252E" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                        <h6>Credit Card</h6>
                                    </div>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <div class="nav-link" id="pills-paypal-tab" data-bs-toggle="pill" data-bs-target="#pills-paypal" role="tab" aria-controls="pills-paypal" aria-selected="false">
                                ...
                                <div class="tab-pane fade show active" id="pills-checkout" role="tabpanel" aria-labelledby="pills-checkout-tab">
                                    <form action="#">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Type here" id="card-name-one" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="card-number-one">Card Number</label>
                                            <input type="text" class="form-control" placeholder="Type here" id="card-number-one" />
                                        </div>
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-md-6 mb-3 mb-lg-0">
                                                    <label for="expiration-date-one">Expiration Date (MM/YY)</label>
                                                    <input type="text" class="form-control" placeholder="Type here" id="expiration-date-one" />
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="cvc-one">CVC</label>
                                                    <input type="text" class="form-control" id="cvc-one" placeholder="Type here" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-4">
                                        ...
                                        <button type="submit" class="button button-lg button--primary w-100">Confirm Payment</button>
                                    </form>
                                </div>
                                ...
                                <div class="tab-pane fade" id="pills-paypal" role="tabpanel" aria-labelledby="pills-paypal-tab">
                                    <form action="#">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Type here" id="card-name-two" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="card-number-two">Card Number</label>
                                            <input type="text" class="form-control" placeholder="Type here" id="card-number-two" />
                                        </div>
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-md-6 mb-3 mb-lg-0">
                                                    <label for="expiration-date-two">Expiration Date (MM/YY)</label>
                                                    <input type="text" class="form-control" placeholder="Type here" id="expiration-date-two" />
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="cvc-two">CVC</label>
                                                    <input type="text" class="form-control" id="cvc-two" placeholder="Type here" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-4">
                                    ...
                                    <div class="productContent__wrapper">
                                        <div class="productContent">
                                            <div class="productContent-item__img productContent-item">
                                                <img src="{{ asset('assets') }}/dist/images/checkout/01.jpg" alt="checkout" />
                                            </div>
                                            <div class="productContent-item__info productContent-item">
                                                <h6 class="font-para--lg">
                                                    <a href="course-details.html">Gamification: Motivation Psychology &amp; The Art of Engagement.</a>
                                                </h6>
                                                <p>by Kevin Gibert</p>
                                                <div class="price">
                                        ...
                                        <div class="productContent">
                                            <div class="productContent-item__img productContent-item">
                                                <img src="{{ asset('assets') }}/dist/images/checkout/02.jpg" alt="checkout" />
                                            </div>
                                            <div class="productContent-item__info productContent-item">
                                                <h6 class="font-para--lg">
                                                    <a href="course-details.html">Digital Art for Beginners - Unleash Your Creativity</a>
                                                </h6>
                                                <p>by Kevin Gibert</p>
                                                <div class="price">
                                                    <h6 class="font-para--md">$12</h6>
