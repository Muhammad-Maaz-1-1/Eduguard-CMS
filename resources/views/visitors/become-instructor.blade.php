            ...
            <div class="container">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb pb-0 mb-0">
                        ...
                        <li class="breadcrumb-item active"><a href="become-instructor.html" class="fs-6 text-secondary">Become an Instructor</a></li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="hero__img-content">
                            <div class="hero__img-content--main">
                                <img src="{{ asset('assets') }}/dist/images/instructor/become.jpg" alt="image" />
                            </div>
                            <img src="{{ asset('assets') }}/dist/images/shape/rec02.png" alt="shape" class="hero hero__img-content--shape-01" />
                            <img src="{{ asset('assets') }}/dist/images/shape/dots/dots-img-06.png" alt="shape" class="hero hero__img-content--shape-02" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="hero__content-info">
                            ...
                            <p class="font-para--lg">
                                Suspendisse id dui sed eros volutpat viverra. Aliquam metus velit, sodales eu fringilla quis, posuere vel massa. Sed ut metus at nisi pharetra suscipit. Donec facilisis faucibus augue, eu sodales ante
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 order-2 order-lg-0">
                        <div class="hero__content-info">
                            ...
                            <p class="font-para--lg">
                                Aed ut metus at nisi pharetra suscipit. Donec facilisis faucibus augue, eu sodales ante tincidunt sed. Integer libero metus, convallis et ipsum mollis, ultrices convallis arcu.
                            </p>
                    ...
                    <div class="col-lg-6 order-1 order-lg-0">
                        <div class="hero__img-content">
                            <div class="hero__img-content--main">
                                <img src="{{ asset('assets') }}/dist/images/instructor/rules.jpg" alt="image" />
                            </div>
                            <img src="{{ asset('assets') }}/dist/images/shape/rec03.png" alt="shape" class="hero hero__img-content--shape-01" />
                            <img src="{{ asset('assets') }}/dist/images/shape/dots/dots-img-08.png" alt="shape" class="hero hero__img-content--shape-02" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="section section--bg-offwhite-one top-bg overflow-hidden sucessfullInstructor pb-0">
            <div class="container">
                ...
                <div class="row feature my-5">
                    <div class="col-lg-4 col-md-6">
                        <div class="cardFeature cardFeature--center">
                            ...
                            <p class="font-para--lg">Vivamus interdum neque massa, eget mattis mi gravida eget. Donec et dictum justo. Vivamus interdum.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="cardFeature cardFeature--center">
                            ...
                            <p class="font-para--lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce sed commodo enim Fusce sed.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="cardFeature cardFeature--center">
                            <div class="cardFeature__icon cardFeature__icon--bg-b">
                                <svg width="20" height="32" viewBox="0 0 20 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9.875 2V30" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                                    <path
                ...
                <div class="section hero hero--four row align-items-center">
                    <div class="col-lg-6">
                        <div class="hero__img-content">
                            <div class="hero__img-content--main">
                                <img src="{{ asset('assets') }}/dist/images/instructor/info-desk.jpg" alt="image" />
                            </div>
                            <img src="{{ asset('assets') }}/dist/images/shape/reactangle-lg.png" alt="shape" class="hero hero__img-content--shape-01" />
                            <img src="{{ asset('assets') }}/dist/images/shape/dots/dots-img-15.png" alt="shape" class="hero hero__img-content--shape-02" />
                            <img src="{{ asset('assets') }}/dist/images/shape/circle2.png" alt="shape" class="hero hero__img-content--shape-03" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="hero__content-info">
            ...
            <div class="section__overlay">
                <span class="section__overlay--shape-01">
                    <img src="{{ asset('assets') }}/dist/images/shape//circle3.png" alt="shape circle" />
                </span>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-12 mx-auto text-center">
                        ...
                        <a href="signup.html" class="button button-md button--primary">Let’s Go</a>
                    </div>
                </div>
            </div>
        </section>
