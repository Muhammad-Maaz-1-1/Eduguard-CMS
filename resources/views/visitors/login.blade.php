    ...
    @extends('visitors.layouts.main')
                ...
                <div class="row align-items-center">
                    <div class="col-xl-5 order-2 order-xl-0">
                        <div class="signup-area-textwrapper">
                            ...
                            <p class="mt-2 mb-lg-4 mb-3">Don't have account? <a href="{{route('register')}}" class="text-black-50">Sign up</a></p>
            ...
            @enderror
                                <div class="form-element success">
                                    ...
                                    <div class="form-alert-input">
                                        <input name="email" type="email" placeholder="Arif Ahmed" id="name" />
        ...
        <div class="dot-images">
            <img src="{{ asset('assets') }}/dist/images/shape/dots/dots-img-10.png" alt="shape" style="z-index: 1;" class="img-fluid first-dotimage" />
