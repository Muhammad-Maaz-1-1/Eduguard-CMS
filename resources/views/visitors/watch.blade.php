                ...
                <div class="col-lg-8">
                    <div class="course-description-start">
                        <div class="video-area">
                            <video controls id="my-video" class="video-js w-100" poster="{{ asset('assets') }}/dist/images/courses/vthumb.jpg" data-setup="{}">
                                <source src="{{ asset('assets') }}/dist/images/courses/video.mp4" class="w-100" />
                            </video>
                        </div>
