                     ...
                     <form action="{{ route('register_submit') }}" method="Post">
                         ...
                         <div class="form-element success">
                             ...
                             <div class="form-alert-input">
                                 <input type="text" name="name" placeholder="Arif Ahmed" id="name" />
                         ...
                         <div class="form-element success emailBox">
                             <div class="form-element active mb-0">
                                 <label for="email">Email</label>
                             </div>
                             <div class="form-alert-input">
                                 <input name="email" type="email" placeholder="arifAhmed@gmail.com" id="email" />
                         ...
                         <div class="form-element active">
                             ...
                             <div class="form-alert-input">
                                 <input name="password" type="password" placeholder="Type here..." id="password" />
                         ...
                         <div class="d-flex align-items-center flex-wrap mt-3 signinButtons">
                             ...
                             <a href="#" class="d-flex text-secondary align-items-center justify-content-center signup-with border twitter rounded-1">
                                 <svg class="me-2" width="22" height="19" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                     <path d="M22 2.63092C21.1819 2.99231 20.3101 3.23185 19.4012 3.34815C20.3363 2.786 21.0499 1.90262 21.3854 0.837846C20.5136 1.36123 19.5511 1.73092 18.5254 1.93723C17.6976 1.04969 16.5179 0.5 15.2309 0.5C12.7339 0.5 10.7236 2.54092 10.7236 5.04292C10.7236 5.40292 10.7539 5.74908 10.8281 6.07862C7.0785 5.89446 3.76063 4.08477 1.53175 1.328C1.14262 2.00785 0.914375 2.786 0.914375 3.62369C0.914375 5.19662 1.71875 6.59092 2.91775 7.39815C2.19313 7.38431 1.48225 7.17246 0.88 6.83877C0.88 6.85262 0.88 6.87062 0.88 6.88862C0.88 9.09569 2.44337 10.9289 4.4935 11.3512C4.12637 11.4523 3.72625 11.5008 3.311 11.5008C3.02225 11.5008 2.73075 11.4842 2.45712 11.4232C3.0415 13.2218 4.69975 14.5442 6.6715 14.5871C5.137 15.7958 3.18863 16.5242 1.07938 16.5242C0.7095 16.5242 0.35475 16.5075 0 16.4618C1.99787 17.7592 4.36562 18.5 6.919 18.5C15.2185 18.5 19.756 11.5769 19.756 5.576C19.756 5.37523 19.7491 5.18139 19.7395 4.98892C20.6346 4.34923 21.3867 3.55031 22 2.63092Z" fill="#03A9F4"></path>
                                 </svg>
                                 Twitter
                             </a>
                         </div>
