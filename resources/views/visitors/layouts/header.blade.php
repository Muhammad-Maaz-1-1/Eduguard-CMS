        ...
        <nav class="navbar navbar-expand-xl navbar-light bg-transparent">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ route('home') }}">
                    <img src="{{ asset('assets') }}/dist/images/logo/logo.png" alt="Logo" class="img-fluid" />
                </a>
                ...
                <div class="collapse navbar-collapse d-none d-xl-block d-none d-xl-block" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{ route('courses') }}">
                                Course
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="d-flex align-items-center justify-content-between rightContent">
                        <form class="header__Search-form" action="{{ route('search_submit') }}" method="GET">
                        ...
                        @if (!Auth::check())
                            <a href="{{ route('login') }}" class="button button--text">Sign in</a>
                            <a href="{{ route('register') }}" class="button button--dark">Sign Up</a>
                        @else
                            <div class="user-image ms-3">
                                @if (Auth::user()->role === 'Student')
                                    <a href="{{ route('students_profile') }}">
                                        <img src="{{ asset('assets') }}/src/images/student.png" alt="User">
                                    </a>
                                @elseif (Auth::user()->role === 'Instructor')
                                    @if ($profileModel && $profileModel->image)
                ...
                <div class="navbar-mobile">
                    <div>
                        <div class="navbar-mobile__top">
                            <a href="{{ route('home') }}">
                                <img src="{{ asset('assets') }}/dist/images/logo/logo.png" alt="brand"
                                    class="img-fluid" />
                            </a>
                            <div>
                            ...
                            <ul class="navbar-mobile__menu-list">
                                <li class="active navbar-mobile__menu-item">
                                    ...
                                    <ul class="navbar-mobile__menu-dropmenu">
                                        <li><a href="{{ route('home') }}" class="active">Homepage 01</a></li>
