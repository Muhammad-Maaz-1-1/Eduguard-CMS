              ...
              <div class="container">
                          ...
                          <div>
                              <div class="students-info-intro-start">
                                  <div class="image">
                                      ...
                                      @else
                                          <img src="{{ asset('assets') }}/assets/src/images/man.png" alt="Student" />
                                      @endif
                                  </div>
                                  <div class="text">
                                      ...
                                      <p>
                                          @if ($profile && $profile->user_id === Auth::user()->id)
                                              {{ $profile->skill }}
                                          @else
                                              <a href="{{ route('edit_student_profile') }}">Add Skill</a>
                                          @endif
                                      </p>
                                  </div>
                              </div>
                              ...
                              <div class="students-info-intro-end">
                                  <div class="enrolled-courses">
                                      ...
                                      <div class="enrolled-courses-text">
                                          <h6 class="font-title--xs">{{ $enrollmentCourse ?? '0' }}</h6>
                  ...
                  <div class="row students-info-intro d-none">
                      <div class="col-lg-6">
                          <div class="students-info-intro-start">
                              <div class="image">
                                  <img src="{{ asset('assets') }}/dist/images/user/user-img-01.jpg" alt="Student" />
                              </div>
                              <div class="text">
                  ...
                  <div class="students-info-main">
                      <div class="tab-content" id="nav-tabContent">
                              ...
                              <div class="tab-content__profile">
                                      ...
                                      <div class="about-student">
                                          ...
                                          <p class="font-para--md">
                                              @if ($profile && $profile->user_id === Auth::user()->id)
                                                  {{ $profile->about }}
                                              @else
                                                  <a href="{{ route('edit_student_profile') }}">tell me About your self</a>
                                              @endif
                                          </p>
                                      </div>
                                  </div>
                                  <div class="tab-content__profile-content">
                                      <div class="info-student">
                                          <h6 class="font-title--card">{{ Auth()->user()->name }} Information</h6>
                                              ...
                                              <dd class="col-sm-8">
                                                  <p>
                                                      @if ($profile && $profile->user_id === Auth::user()->id)
                                                          {{ $profile->skill }}
                                                      @else
                                                          <a href="{{ route('edit_student_profile') }}">
                                                              Add skill </a>
                                                      @endif
                                                  </p>
                                              </dd>
                          ...
                          <div class="tab-pane fade" id="nav-coursesall" role="tabpanel"
                                          ...
                                          <div class="contentCard contentCard--watch-course">
                                              <div class="contentCard-top">
                                                  <a href="course-details.html">
                                                          <img
                                                              src="{{ asset('uploads/' . $item->courses->image) }}"
                                              ...
                                              <div class="contentCard-bottom">
                                                  <h5>
                                                      <a href="course-details.html"
                                                          class="font-title--card">{{ $item->courses->title }}</a>
                                                  </h5>
                                                  <div
                                                      class="contentCard-info d-flex align-items-center justify-content-between">
                                                      <a href="instructor-profile.html"
                                                          class="contentCard-user d-flex align-items-center">
                                                          @if ($item->course && $item->course->profile && $item->course->profile->image !== null)
                                                          <img style="width: 70px; height: 70px; border-radius: 200px;"
                                                              src="{{ asset('uploads/' . $item->course->profile->image) }}"
                                                              alt="images" class="img-fluid" />
                                                      @else
                                                          <img style="width: 70px; height: 70px; border-radius: 200px;"
                                                              src="{{ asset('assets/src/images/teacher.png') }}"
                                                              alt="Instructor" />
                                                      @endif
                                                          <p class="font-para--md">
                                                            @if ($item->courses && $item->courses->user)
                                                            {{ $item->courses->user->name }}
                                                        @endif
                                                          </p>
                                                      </a>
                                                  ...
                                                  <a class="button button-md button--primary-outline w-100 my-3"
                                                      href="{{ route('watch') }}">Watch Course</a>
                              ...
                              <div class="row">
                                      ...
                                      <div class="contentCard contentCard--watch-course">
                                          <div class="contentCard-top">
                                              <a href="course-details.html"><img
                                                      src="{{ asset('assets') }}/dist/images/courses/demo-img-01.png"
                                          ...
                                          <div class="contentCard-bottom">
                                              ...
                                              <div
                                                  ...
                                                  <a href="instructor-profile.html"
                                                      class="contentCard-user d-flex align-items-center">
                                                      <img src="{{ asset('assets') }}/dist/images/courses/7.png"
                                  ...
                                  <div class="col-lg-4 col-md-6 col-md-6 mb-4">
                                      <div class="contentCard contentCard--watch-course">
                                          <div class="contentCard-top">
                                              <a href="course-details.html"><img
                                                      src="{{ asset('assets') }}/dist/images/courses/demo-img-02.png"
                                                      alt="images" class="img-fluid" /></a>
                                          </div>
                                          <div class="contentCard-bottom">
                                              <h5>
                                  ...
                                  <div class="col-lg-4 col-md-6 col-md-6 mb-4">
                                      <div class="contentCard contentCard--watch-course">
                                          <div class="contentCard-top">
                                              <a href="course-details.html"><img
                                                      src="{{ asset('assets') }}/dist/images/courses/demo-img-03.png"
                                                      alt="images" class="img-fluid" /></a>
                                          </div>
                                          <div class="contentCard-bottom">
                                              <h5>
                                  ...
                                  <div class="col-lg-4 col-md-6 col-md-6 mb-4">
                                      <div class="contentCard contentCard--watch-course">
                                          <div class="contentCard-top">
                                              <a href="course-details.html"><img
                                                      src="{{ asset('assets') }}/dist/images/courses/demo-img-04.png"
                                                      alt="images" class="img-fluid" /></a>
                                          </div>
                                          <div class="contentCard-bottom">
                                              <h5>
                                  ...
                                  <div class="col-lg-4 col-md-6 col-md-6 mb-4">
                                      <div class="contentCard contentCard--watch-course">
                                          <div class="contentCard-top">
                                              <a href="course-details.html"><img
                                                      src="{{ asset('assets') }}/dist/images/courses/demo-img-05.png"
                                                      alt="images" class="img-fluid" /></a>
                                          </div>
                                          <div class="contentCard-bottom">
                                              <h5>
                                          ...
                                          <div
                                              ...
                                              <div class="purchase-area-items">
                                                  <div
                                                      ...
                                                      <div class="image">
                                                          <a href="#">
                                                              <img src="{{ asset('assets') }}/dist/images/courses/demo-img-03.png"
                                                                  alt="Image" />
                                                          </a>
                                                      </div>
                                                      <div class="text d-flex flex-column flex-lg-row">
                                                          <div class="text-main">
                                                              <h6>
                                                                  <a href="#">Advanced Digital Comic Coloring
                                                                      Concepts & Techniques</a>
                                                              </h6>
                                                  ...
                                                  <div
                                                      ...
                                                      <div class="image">
                                                          <a href="#">
                                                              <img src="{{ asset('assets') }}/dist/images/courses/demo-img-05.png"
                                                                  alt="Image" />
                                                          </a>
                                                      </div>
                                                      <div class="text d-flex flex-column flex-lg-row">
                                                  ...
                                                  <div
                                                      ...
                                                      <div class="image">
                                                          <a href="#">
                                                              <img src="{{ asset('assets') }}/dist/images/courses/8.jpg"
                                                                  alt="Image" />
                                                          </a>
                                                      </div>
                                                      <div class="text d-flex flex-column flex-lg-row">
                                              ...
                                              <div class="purchase-area-items">
                                                  <div
                                                      ...
                                                      <div class="text d-flex flex-column flex-lg-row">
                                                          <div class="text-main">
                                                              <h6>
                                                                  <a href="#">Digital Art for Beginners - Unleash
                                                                      Your Creativity</a>
                                                              </h6>
                                                              <p>By <a href="instructorcourses.html">Kevin Gilbert</a></p>
                                                          </div>
                                      ...
                                      <p style="color: #42414b !important; font-size: 18px !important;">
                                          ...
                                          <svg width="31" height="31" viewBox="0 0 31 31" fill="none"
                                              ...
                                              <defs>
                                                  ...
                                                  <linearGradient id="paint1_linear" x1="15.1347" y1="0.365178"
                                                      x2="15.8653" y2="26.6346" gradientUnits="userSpaceOnUse">
                                      ...
                                      <div class="white-bg">
                                          <div class="change-image-wizard">
                                              <div class="image mx-auto">
                                                  <img src="{{ asset('assets') }}/dist/images/user/user-img-01.jpg"
                                                      alt="User" />
                                              </div>
                                              <form action="#">
